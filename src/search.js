 ...
 const buyStock=async ()=>{
   ...
   console.log(currentWallet)
    //check if the quantity is not 0
        //check if the user has emough cash in the wallet to be able to make a purchase
    ...
    if(buyQuantity===0){
        ...
        console.log('the cash needed is' ,cashNeeded)
    ...
    return (
     <div className={'border p-5'}>
        ...
        <div className="grid grid-cols-2">
          ...
          <div className={'border p-5'}>
            <span onClick={fetchQuote} className={'bg-gray-600 cursor-pointer p-2 rounded text-white text-xl pl-6 pr-6'}>Get Quote</span>
          </div>
        </div>
       ...
       {ticker && <div className="grid grid-cols-2">
          ...
          <input type="number" onChange={onBuyChange} className={'border'} value={buyQuantity}/>&nbsp;&nbsp;
             ...
             <span className={'bg-blue-600 cursor-pointer  p-2 rounded text-white text-xl pl-6 pr-6'} onClick={buyStock}>Buy</span>&nbsp;&nbsp;&nbsp;
             
         {/*<span className={'bg-red-600 cursor-pointer p-2 rounded text-white text-xl pl-6 pr-6'}>Sell</span>*/}
          </div>
        </div>}
